...
set [ find default-name=wlan1 ] adaptive-noise-immunity=ap-and-client-mode \
    band=5ghz-onlyn basic-rates-a/g="" channel-width=20/40mhz-eC disabled=no \
    frequency=5485 frequency-mode=superchannel guard-interval=long \
    hw-retries=4 mode=bridge mtu=1492 multicast-helper=disabled name=\
    wlan1-gateway nv2-cell-radius=10 nv2-preshared-key=89242729134St \
    nv2-queue-count=4 nv2-security=enabled scan-list=5485-6100 \
...
/system scheduler
add disabled=yes interval=1m name=PingReset on-event=":local PingCount 6;\r\
...
add disabled=yes interval=30s name=ResetWireless on-event=":local PingCount 6;\
    \r\
    \n:local HostPing 192.168.88.2;\r\
    \n:local PingResultA [/ping \$HostPing count=\$PingCount]; \r\
    \n\r\
    \n:if (\$PingResultA < 1) do={ \r\
    \n/interface wireless disable \r\
    \n:delay 2s  \r\
    \n/interface wireless enable} \r\
